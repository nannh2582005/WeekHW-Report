\section{Min subarray sum [Trung bình]}
...
\subsection{Mã nguồn C++11 (Tách module)}
    ...
    SubarrayResult minSubarray(const vector<long long>& a) {
    ...
    int main() {
        ...
        SubarrayResult res = minSubarray(a);
        fout << "min_sum=" << res.sum << " / l=" << res.l << " / r=" << res.r << "\n";
        return 0;
    }
\end{lstlisting}
